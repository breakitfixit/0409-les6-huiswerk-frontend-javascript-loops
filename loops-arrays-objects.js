...
// heeeel toevallig had ik dit er zelf al bijverzonnen in opdracht 2.
...
/*  nogmaals opgesteld, maar zonder if-else  */
...
for (let i = 0; i < students.length; i++) {
    students[i].neighborhood = neighborhoodLookup[students[i].zipCode];
}
